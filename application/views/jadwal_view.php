                                ...
                                <div class="module-body table">
                                    <table class="table table-message">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="cell-author hidden-phone hidden-tablet"><?=$row->id_login?></td>
                                                <td class="cell-title"><?=$row->hari?></td>
                                                <td class="cell-time align-right"><?=$row->jam_kerja?></td>
                                                <td class="cell-time align-right"><?=$row->jam_kerja_ed?></td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
