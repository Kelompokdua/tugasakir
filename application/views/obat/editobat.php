            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Form obat </h2>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form Edit obat</h5>
                                <div class="card-body">
                                    <?php 
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <input type="hidden" id="basicinput" name="idobat" value="<?php echo $obat[0]->id_obat ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nama obat</label>
                                    <div class="controls">
                                        <input type="text" id="basicinput" name="nama" value="<?php echo $obat[0]->nama ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Jenis Obat</label>
                                    <div class="controls">
                                        <input type="text" id="basicinput" name="jenis" value="<?php echo $obat[0]->jenis_obat ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Harga Obat</label>
                                    <div class="controls">
                                        <input type="text" id="basicinput" name="harga" value="<?php echo $obat[0]->harga_obat ?>" class="form-control">
                                    </div>
                                </div>
                                <br><br>
                                <div class="control-group">
