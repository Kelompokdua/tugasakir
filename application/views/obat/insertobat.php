            ...
            <div class="container-fluid  dashboard-content">
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form Insert obat</h5>
                                <div class="card-body">
                                    <?php 
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="basicinput" name="jenis"  class="form-control">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Harga Obat</label>
                                    <div class="controls">
                                        <input type="number" id="basicinput" name="harga"  class="form-control">
                                    </div>
                                </div>
                                <br><br>
                                <div class="control-group">
