            ...
            <div class="container-fluid  dashboard-content">
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form Hapus pasien</h5>
                                <div class="card-body">
                            <div>
                                    <center>
                                        <font size="5">Apakah Anda yakin ingin menghapus pasien INI ?</font>
                                    </center>
                                </div>
                                <br>
                                <br>
                                <br>
                                    <div>
                                        <center>
                                            <font size="3" color="black">Nama Pasien</font><br><br>
                                            <font size="5"><?php echo $pasien[0]->nama_pasien; ?></font><br><br>
                                        <font size="3" color="black">Tanggal Lahir</font><br><br>
                                            <font size="5"><?php echo $pasien[0]->tgl_lahir; ?></font>
                                        </center>
                                        <br><br>
                                        <?php echo form_open('pasien/hapus/'.$this->uri->segment(3)); ?>
                                        <div class="control-group">
                                            <div class="controls">
                                                <input type="hidden" id="basicinput" name="idpasien" value="<?php echo $this->uri->segment(3); ?>" class="span8">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <div class="controls">
