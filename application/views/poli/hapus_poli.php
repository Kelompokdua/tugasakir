					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
								...
								<div>
									<center>
										<font size="5">Apakah Anda yakin ingin menghapus POLI INI ?</font>
									</center>
								</div>
								<br>
								<br>
								<br>
									<div>
										<center>
											<font size="3" color="black">Nama Poli</font><br><br>
											<font size="5"><?php echo $poli[0]->nama; ?></font><br><br>
										<font size="3" color="black">Keterangan</font><br><br>
											<font size="5"><?php echo $poli[0]->keterangan; ?></font>
										</center>
									</div>
									<br>
									<br>
									<div>
										...
										<?php echo form_open('poli/hapus/'.$this->uri->segment(3)); ?>
										<div class="control-group">
											<div class="controls">
												<input type="hidden" id="basicinput" name="idpoli" value="<?php echo $this->uri->segment(3); ?>" class="span8">
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
