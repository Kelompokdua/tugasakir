            ...
            <div class="container-fluid  dashboard-content">
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form List dokter</h5>
                                <div align="right">
                                    <a href="<?php echo base_url('index.php/dokter/insert/');?>"><button type="button" class="btn btn-success">Tambah dokter</button></a> 
                                
                                </div>
                                <div class="card-body">
                                   <table class="w3-table-all" id="tablepeg">
										<thead>
											<tr><th>No</th><th>Nama dokter</th><th>Poli</th><th>Biaya</th><th>Action</th></tr>
										</thead>
