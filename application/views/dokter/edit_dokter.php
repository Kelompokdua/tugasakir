 					...
 					?>
 						...
 						<?php } ?>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" name="nama" value="<?php echo $dokter[0]->nama_dokter ?>" class="span8">
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="number" id="basicinput" name="biaya" value="<?php echo $dokter[0]->biaya ?>" class="span8">
											</div>
										</div>
