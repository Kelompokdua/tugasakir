									...
									<table border="1" class="w3-table-all" id="tablepeg">
										...
										<tbody>
											...
											foreach ($rm as $f){
												...
												";?>
												<td>
												<a href="<?php echo base_url('index.php/poli/edit/'); echo $f->id_pelayanan; ?>"><button type="button" class="btn btn-info"> Verifikasi</button></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('index.php/poli/edit/'); echo $f->id_pelayanan; ?>"><button type="button" class="btn btn-success"> print</button></a>
